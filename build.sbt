...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/circuit-http4s"),
        "git@github.com:ChristopherDavenport/circuit-http4s.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/circuit-http4s")),
...
lazy val micrositeSettings = {
  ...
  Seq(
    ...
    micrositeBaseUrl := "/circuit-http4s",
    micrositeDocumentationUrl := "https://www.javadoc.io/doc/io.chrisdavenport/circuit-http4s_2.12",
